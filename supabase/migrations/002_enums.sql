...
-- PostgreSQL     : 16
-- Supabase       : Compatible
-- Idempotent     : Yes — CREATE TYPE IF NOT EXISTS (PG14+)
...
--    Doc03 §1
CREATE TYPE IF NOT EXISTS public.pxl_taxpayer_type AS ENUM (
    'vat',
    'non_vat'
);
...
--    Doc03 §1
CREATE TYPE IF NOT EXISTS public.pxl_income_tax_regime AS ENUM (
    'corporate',
    'individual',
    'partnership',
    'cooperative'
...
--    Doc03 §1
CREATE TYPE IF NOT EXISTS public.pxl_legal_type AS ENUM (
    'sole_proprietor',
    'regular_corporation',
    'opc',
    'partnership',
...
--    Doc03 §1
CREATE TYPE IF NOT EXISTS public.pxl_deduction_method AS ENUM (
    'itemized',
    'osd',
    'eight_percent'
);
...
--    Doc03 §3
CREATE TYPE IF NOT EXISTS public.pxl_fiscal_status AS ENUM (
    'open',
    'closed',
    'locked'
);
...
--    Doc03 §2
CREATE TYPE IF NOT EXISTS public.pxl_approval_type AS ENUM (
    'sequential',
    'parallel',
    'any_one'
);
...
--    Doc03 §3
CREATE TYPE IF NOT EXISTS public.pxl_budget_status AS ENUM (
    'draft',
    'approved',
    'active',
    'superseded'
...
--    Doc03 §3
CREATE TYPE IF NOT EXISTS public.pxl_account_type_code AS ENUM (
    'asset',
    'liability',
    'equity',
    'revenue',
...
--    Doc03 §3
CREATE TYPE IF NOT EXISTS public.pxl_normal_balance AS ENUM (
    'debit',
    'credit'
);
...
--     Doc03 §3
CREATE TYPE IF NOT EXISTS public.pxl_fs_section AS ENUM (
    'current_assets',
    'non_current_assets',
    'current_liabilities',
...
--     Doc03 §3
CREATE TYPE IF NOT EXISTS public.pxl_fs_category AS ENUM (
    'balance_sheet',
    'income_statement',
...
--     Doc03 §3
CREATE TYPE IF NOT EXISTS public.pxl_cash_flow_category AS ENUM (
    'operating',
    'investing',
    'financing'
);
...
--     Doc03 §3
CREATE TYPE IF NOT EXISTS public.pxl_tax_deductibility AS ENUM (
    'fully_deductible',
...
CREATE TYPE IF NOT EXISTS public.pxl_control_account_type AS ENUM (
    'AR_CONTROL',
    'AP_CONTROL',
    'INVENTORY_CONTROL',
    'OUTPUT_VAT_CONTROL',
...
CREATE TYPE IF NOT EXISTS public.pxl_system_account_key AS ENUM (
    'CASH_ON_HAND',
    'CASH_IN_BANK',
    'AR_TRADE',
    'AP_TRADE',
...
--     Doc03 §4
CREATE TYPE IF NOT EXISTS public.pxl_party_entity_type AS ENUM (
    'individual',
    'business',
    'government'
);
...
--     Doc03 §4
CREATE TYPE IF NOT EXISTS public.pxl_vat_registration_status AS ENUM (
    'vat',
    'non_vat'
);
...
--     Doc03 §4
CREATE TYPE IF NOT EXISTS public.pxl_party_special_class AS ENUM (
    'government',
    'peza',
    'boi',
    'foreign_entity'
...
--     Doc03 §5
CREATE TYPE IF NOT EXISTS public.pxl_item_type AS ENUM (
    'inventory',
    'non_inventory',
    'service',
    'fixed_asset'
...
CREATE TYPE IF NOT EXISTS public.pxl_transaction_type AS ENUM (
    'sales_invoice',
    'vendor_bill',
    'receipt',
    'payment_voucher',
...
CREATE TYPE IF NOT EXISTS public.pxl_transaction_status AS ENUM (
    'draft',
    'submitted',
    'approved',
    'posted',
...
--     Doc03 §6, §7
CREATE TYPE IF NOT EXISTS public.pxl_payment_method AS ENUM (
    'cash',
    'check',
    'bank_transfer',
    'online'
...
--     Doc03 §6, §7
CREATE TYPE IF NOT EXISTS public.pxl_vat_direction AS ENUM (
    'output',
    'input'
);
...
--     Doc03 §6, §7, §10
CREATE TYPE IF NOT EXISTS public.pxl_vat_classification AS ENUM (
    'vatable',
    'zero_rated',
    'exempt',
    'government',
...
--     Doc03 §8
CREATE TYPE IF NOT EXISTS public.pxl_je_type AS ENUM (
    'manual',
    'system',
    'reversal',
    'opening',
...
--     Doc03 §8
CREATE TYPE IF NOT EXISTS public.pxl_je_status AS ENUM (
    'draft',
    'posted',
    'reversed'
);
...
--     Doc03 §8, §33, §35
CREATE TYPE IF NOT EXISTS public.pxl_recurring_frequency AS ENUM (
    'monthly',
    'quarterly',
    'annually'
);
...
--     Doc03 §8
CREATE TYPE IF NOT EXISTS public.pxl_recurring_status AS ENUM (
    'active',
    'paused',
    'completed',
    'cancelled'
...
CREATE TYPE IF NOT EXISTS public.pxl_entry_side AS ENUM (
    'debit',
    'credit'
);
...
--     Doc03 §9, Doc06 §2
CREATE TYPE IF NOT EXISTS public.pxl_account_source AS ENUM (
    'fixed',
    'from_system_config',
    'from_item',
    'from_customer',
...
--     Doc03 §9, Doc06 §2
CREATE TYPE IF NOT EXISTS public.pxl_amount_source AS ENUM (
    'line_subtotal',
    'line_vat',
    'line_ewt',
    'header_total',
...
--     Doc03 §9, Doc06 §2
CREATE TYPE IF NOT EXISTS public.pxl_applies_to AS ENUM (
    'all',
    'vat_lines_only',
    'ewt_lines_only',
    'zero_vat_lines',
...
--     Doc03 §9, §32
CREATE TYPE IF NOT EXISTS public.pxl_subsidiary_ledger_type AS ENUM (
    'ar',
    'ap',
    'inventory',
    'fixed_asset'
...
--     Doc03 §9
CREATE TYPE IF NOT EXISTS public.pxl_posting_batch_status AS ENUM (
    'pending',
    'processing',
    'completed',
    'partial_fail',
...
CREATE TYPE IF NOT EXISTS public.pxl_series_type AS ENUM (
    'sales_invoice',
    'cash_sale',
    'receipt',
    'vendor_bill',
...
--     Doc03 §25
CREATE TYPE IF NOT EXISTS public.pxl_reset_frequency AS ENUM (
    'never',
    'monthly',
    'annually'
);
...
--     Doc03 §41, Doc07 §3
CREATE TYPE IF NOT EXISTS public.pxl_change_type AS ENUM (
    'insert',
    'update',
    'delete'
);
...
CREATE TYPE IF NOT EXISTS public.pxl_activity_type AS ENUM (
    'login_success',
    'login_failed',
    'logout',
    'session_expired',
...
--     Doc03 §41, Doc07
CREATE TYPE IF NOT EXISTS public.pxl_dat_type AS ENUM (
    'journal',
    'sales',
    'purchases',
    'inventory'
...
--     Doc03 §41
CREATE TYPE IF NOT EXISTS public.pxl_alert_type AS ENUM (
    'atp_nearing_limit',
    'number_gap_detected',
...
--     Doc03 §41
CREATE TYPE IF NOT EXISTS public.pxl_alert_severity AS ENUM (
    'info',
    'warning',
    'critical'
);
...
--     Doc03 §40
CREATE TYPE IF NOT EXISTS public.pxl_approval_request_status AS ENUM (
    'pending',
    'approved',
    'rejected',
    'returned',
...
--     Doc03 §40
CREATE TYPE IF NOT EXISTS public.pxl_approval_action AS ENUM (
    'approve',
    'reject',
    'return',
    'escalate'
...
--     Doc03 §14, §15
CREATE TYPE IF NOT EXISTS public.pxl_notification_channel AS ENUM (
    'in_app',
    'email',
    'sms'
);
...
--     Doc03 §14
CREATE TYPE IF NOT EXISTS public.pxl_notification_status AS ENUM (
    'pending',
    'sent',
    'failed',
    'delivered'
...
--     Doc03 §39, Doc09
CREATE TYPE IF NOT EXISTS public.pxl_permission_action AS ENUM (
    'view',
    'create',
    'edit',
    'delete',
...
--     Doc03 §17
CREATE TYPE IF NOT EXISTS public.pxl_period_close_status AS ENUM (
    'in_progress',
    'pending_lock',
    'locked'
);
...
--     Doc03 §17
CREATE TYPE IF NOT EXISTS public.pxl_close_task_status AS ENUM (
    'pending',
    'in_progress',
    'completed',
    'waived'
...
--     Doc03 §15, Doc08
CREATE TYPE IF NOT EXISTS public.pxl_import_batch_status AS ENUM (
    'pending',
    'validating',
    'validated',
    'importing',
...
--     Doc03 §15, Doc08
CREATE TYPE IF NOT EXISTS public.pxl_import_row_status AS ENUM (
    'pending',
    'valid',
    'invalid',
    'imported',
...
--     Doc03 §15, Doc08
CREATE TYPE IF NOT EXISTS public.pxl_import_file_format AS ENUM (
    'csv',
    'xlsx',
    'json'
);
...
--     Doc03 §16, §44, Doc08
CREATE TYPE IF NOT EXISTS public.pxl_export_format AS ENUM (
    'pdf',
    'xlsx',
    'csv',
    'dat',
...
--     Doc03 §44, Doc08
CREATE TYPE IF NOT EXISTS public.pxl_export_status AS ENUM (
    'queued',
    'processing',
    'completed',
    'failed'
...
--     Doc03 §15, Doc08
CREATE TYPE IF NOT EXISTS public.pxl_validation_severity AS ENUM (
    'error',
    'warning'
);
...
--     Doc03 §11, §12, §13
CREATE TYPE IF NOT EXISTS public.pxl_filing_status AS ENUM (
    'draft',
    'filed',
    'amended'
);
...
--     Doc03 §27
CREATE TYPE IF NOT EXISTS public.pxl_bir_form_code AS ENUM (
    '2550M',
    '2550Q',
    '2551Q',
    '1601EQ',
...
CREATE TYPE IF NOT EXISTS public.pxl_filing_frequency AS ENUM (
    'monthly',
    'quarterly',
    'annual'
);
...
--     Doc03 §12
CREATE TYPE IF NOT EXISTS public.pxl_tax_account_type AS ENUM (
    'vat',
    'ewt',
    'fwt',
    'percentage_tax'
...
--     Doc03 §13
CREATE TYPE IF NOT EXISTS public.pxl_credit_type AS ENUM (
    'ewt_2307',
...
--     Doc03 §13
CREATE TYPE IF NOT EXISTS public.pxl_book_tax_reconciliation_type AS ENUM (
    'add_back',
    'deduction',
    'permanent',
    'temporary'
...
--     Doc03 §20
CREATE TYPE IF NOT EXISTS public.pxl_inventory_adjustment_type AS ENUM (
    'write_off',
    'count_adjustment',
    'damage',
    'expiry',
...
CREATE TYPE IF NOT EXISTS public.pxl_movement_type AS ENUM (
    'IN',
    'OUT'
);
...
--     Doc03 §24
CREATE TYPE IF NOT EXISTS public.pxl_depreciation_method AS ENUM (
    'straight_line',
    'declining_balance',
    'sum_of_years_digits',
    'units_of_production'
...
--     Doc03 §24
CREATE TYPE IF NOT EXISTS public.pxl_disposal_type AS ENUM (
    'sale',
    'write_off',
    'trade_in'
);
...
--     Doc03 §24
CREATE TYPE IF NOT EXISTS public.pxl_depreciation_run_status AS ENUM (
    'pending',
    'processing',
    'completed',
    'failed'
...
--     Doc03 §24
CREATE TYPE IF NOT EXISTS public.pxl_depreciation_entry_status AS ENUM (
    'pending',
    'processed',
    'skipped',
    'error'
...
--     Doc03 §21
CREATE TYPE IF NOT EXISTS public.pxl_reconciliation_status AS ENUM (
    'unmatched',
    'matched',
    'cleared',
    'exception'
...
--     Doc03 §21
CREATE TYPE IF NOT EXISTS public.pxl_bank_adjustment_type AS ENUM (
    'debit_memo',
    'credit_memo',
    'bank_charge',
    'interest_income',
...
--     Doc03 §21
CREATE TYPE IF NOT EXISTS public.pxl_recon_line_type AS ENUM (
    'outstanding_check',
    'deposit_in_transit',
    'bank_adjustment',
    'book_adjustment'
...
--     Doc03 §33
CREATE TYPE IF NOT EXISTS public.pxl_prepaid_type AS ENUM (
    'prepaid_rent',
    'prepaid_insurance',
    'prepaid_software',
...
--     Doc03 §33, §35
CREATE TYPE IF NOT EXISTS public.pxl_schedule_status AS ENUM (
    'active',
    'completed',
    'cancelled'
);
...
--     Doc03 §35
CREATE TYPE IF NOT EXISTS public.pxl_deferred_revenue_type AS ENUM (
    'annual_retainer',
    'service_contract',
    'subscription',
    'advance_billing',
...
--     Doc03 §33, §35
CREATE TYPE IF NOT EXISTS public.pxl_schedule_run_status AS ENUM (
    'pending',
    'processing',
    'completed',
    'failed',
...
--     Doc03 §33, §35
CREATE TYPE IF NOT EXISTS public.pxl_run_item_status AS ENUM (
    'pending',
    'processed',
    'skipped'
);
...
--     Doc03 §33, §35
CREATE TYPE IF NOT EXISTS public.pxl_run_detail_status AS ENUM (
    'pending',
    'success',
    'failed',
    'rolled_back'
...
--     Doc03 §32
CREATE TYPE IF NOT EXISTS public.pxl_document_relationship_type AS ENUM (
    'generated_journal',
    'reversed_by',
    'paid_by',
    'credit_applied',
...
--     Doc03 §19
CREATE TYPE IF NOT EXISTS public.pxl_party_merge_type AS ENUM (
    'customer',
    'supplier',
    'mixed'
);
